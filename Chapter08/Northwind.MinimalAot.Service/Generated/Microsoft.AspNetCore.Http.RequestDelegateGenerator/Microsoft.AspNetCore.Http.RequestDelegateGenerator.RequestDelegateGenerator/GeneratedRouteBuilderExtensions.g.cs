...
namespace Microsoft.AspNetCore.Http.Generated
{
    ...
    file static class GeneratedRouteBuilderExtensionsCore
    {
        ...
        [InterceptsLocation(@"J:\NET8_Practise\AppsAndService\Chapter08\Northwind.MinimalAot.Service\WebApplication.Extensions.cs", 12, 13)]
        ...
        [InterceptsLocation(@"J:\NET8_Practise\AppsAndService\Chapter08\Northwind.MinimalAot.Service\WebApplication.Extensions.cs", 14, 13)]
        [InterceptsLocation(@"J:\NET8_Practise\AppsAndService\Chapter08\Northwind.MinimalAot.Service\WebApplication.Extensions.cs", 16, 13)]
            ...
            Delegate handler)
        {
            MetadataPopulator populateMetadata = (methodInfo, options) =>
            {
                ...
                Debug.Assert(options.EndpointBuilder != null, "EndpointBuilder not found.");
                options.EndpointBuilder.Metadata.Add(new System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.AspNetCore.Http.RequestDelegateGenerator, Version=8.0.14.0, Culture=neutral, PublicKeyToken=adb9793829ddae60", "8.0.14.0"));
                options.EndpointBuilder.Metadata.Add(new ProducesResponseTypeMetadata(statusCode: StatusCodes.Status200OK, type: typeof(global::System.Collections.Generic.List<global::Northwind.MinimalAot.Service.Product>), contentTypes: GeneratedMetadataConstants.JsonContentType));
                return new RequestDelegateMetadataResult { EndpointMetadata = options.EndpointBuilder.Metadata.AsReadOnly() };
            };
            RequestDelegateFactoryFunc createRequestDelegate = (del, options, inferredMetadataResult) =>
            {
                ...
                Debug.Assert(options.EndpointBuilder.ApplicationServices != null, "ApplicationServices not found.");
                Debug.Assert(options.EndpointBuilder.FilterFactories != null, "FilterFactories not found.");
                var handler = Cast(del, global::System.Collections.Generic.List<global::Northwind.MinimalAot.Service.Product> (global::System.Decimal? arg0= default) => throw null!);
                EndpointFilterDelegate? filteredInvocation = null;
                var serviceProvider = options.ServiceProvider ?? options.EndpointBuilder.ApplicationServices;
                ...
                jsonSerializerOptions.MakeReadOnly();
                var objectJsonTypeInfo = (JsonTypeInfo<object?>)jsonSerializerOptions.GetTypeInfo(typeof(object));
                var responseJsonTypeInfo =  (JsonTypeInfo<global::System.Collections.Generic.List<global::Northwind.MinimalAot.Service.Product>?>)jsonSerializerOptions.GetTypeInfo(typeof(global::System.Collections.Generic.List<global::Northwind.MinimalAot.Service.Product>));
                var minimumUnitPrice_RouteOrQueryResolver = GeneratedRouteBuilderExtensionsCore.ResolveFromRouteOrQuery("minimumUnitPrice", options.RouteParameterNames);
                ...
                if (options.EndpointBuilder.FilterFactories.Count > 0)
                {
                    filteredInvocation = GeneratedRouteBuilderExtensionsCore.BuildFilterDelegate(ic =>
                    {
                        ...
                        return ValueTask.FromResult<object?>(handler(ic.GetArgument<global::System.Decimal?>(0)!));
                    },
                    options.EndpointBuilder,
                    handler.Method);
                }
                ...
                {
                    var wasParamCheckFailure = false;
                    // Endpoint Parameter: minimumUnitPrice (Type = decimal?, IsOptional = True, IsParsable = True, IsArray = False, Source = RouteOrQuery)
                    var minimumUnitPrice_raw = minimumUnitPrice_RouteOrQueryResolver(httpContext);
                    var minimumUnitPrice_temp = minimumUnitPrice_raw.Count > 0 ? (string?)minimumUnitPrice_raw : null;
                    global::System.Decimal? minimumUnitPrice_parsed_temp = default;
                    if (GeneratedRouteBuilderExtensionsCore.TryParseExplicit<decimal>(minimumUnitPrice_temp!, CultureInfo.InvariantCulture, out var minimumUnitPrice_temp_parsed_non_nullable))
                    {
                        minimumUnitPrice_parsed_temp = minimumUnitPrice_temp_parsed_non_nullable;
                    }
                    else if (string.IsNullOrEmpty(minimumUnitPrice_temp))
                    {
                        minimumUnitPrice_parsed_temp = default;
                    }
                    else
                    {
                        wasParamCheckFailure = true;
                    }
                    decimal? minimumUnitPrice_local = minimumUnitPrice_parsed_temp!;
                    ...
                    var result = handler(minimumUnitPrice_local);
                ...
                async Task RequestHandlerFiltered(HttpContext httpContext)
                {
                    ...
                    var result = await filteredInvocation(EndpointFilterInvocationContext.Create<global::System.Decimal?>(httpContext, minimumUnitPrice_local));
                    if (result is not null)
                    {
                        await GeneratedRouteBuilderExtensionsCore.ExecuteReturnAsync(result, httpContext, objectJsonTypeInfo);
                    }
